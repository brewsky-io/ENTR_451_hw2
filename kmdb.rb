...
for role in all_roles
  ...
  puts "#{movie["title"].ljust(23)} #{actor["name"].ljust(21)}  #{role["character_name"]}"
end
...
# TODO!
ari = Agent.find_by({"name" => "Ari Emanuel"})
represented_actors = Actor.where({"agent_id" => ari["id"]})
