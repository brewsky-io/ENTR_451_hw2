...
DROP TABLE IF EXISTS agents; -- i.e. users
                          ...
                          actor_id INTEGER,
                            ...
                            CREATE TABLE agents (
                              id INTEGER PRIMARY KEY AUTOINCREMENT,
                                ...
                                INSERT INTO agents (name) VALUES ("Ari Emanuel"); -- 1

                                UPDATE actors SET agent_id = 1 WHERE id = 1; -- Christian Bale
